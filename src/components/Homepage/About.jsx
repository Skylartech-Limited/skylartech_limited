...
const About = () => {
  return (
    <>
      <Helmet>
        <title>
          About Skylartech Limited | PMI® Premier Authorized Training Partner in
          Kenya
        </title>
        <meta
          name="description"
      ...
      <div className="relative overflow-hidden bg-slate-950 text-gray-800">
            ...
            >
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/30 backdrop-blur-xl px-6 py-5 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                ...
                <p className="text-lg md:text-xl leading-relaxed text-white/85">
                  Skylartech Limited did not begin as a business idea. It began
                  with a simple question that refused to go away — why do
                  capable professionals struggle with globally recognized
                  certifications designed to elevate their careers?
                </p>
              </div>
            </motion.div>
        ...
        <section className="relative py-28 px-5 sm:px-8 lg:px-12 overflow-hidden border-t border-white/5">
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            >
              <SectionLabel>
                <GraduationCap className="w-3.5 h-3.5 text-pink-300" />A
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="mt-8 text-lg md:text-xl text-white/70 leading-relaxed">
                  ...
                  Training Partner delivering globally aligned project
                  management training built around clarity, structure, and
                  practical mastery.
                </p>
          ...
          <div className="relative max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <p className="mt-6 text-white/60 max-w-3xl mx-auto text-base leading-relaxed">
                We design learning experiences that adapt to professionals,
                teams, and enterprise organizations — without compromising
                structure, quality, or certification outcomes.
              </p>
            </motion.div>
              ...
              {deliveryFormats.map((format) => {
                ...
                return (
                  <motion.div
                    ...
                    variants={fadeUp}
                    className={
                      format.featured ? "sm:col-span-2 lg:col-span-1" : ""
                    }
                  >
                    <GlassCard className="p-6 h-full group">
                      <div className="flex items-center gap-3 mb-4">
                        <span
                          className={`p-2.5 rounded-xl ${colors.bg} transition-transform duration-300 group-hover:scale-110`}
                        >
          ...
          <div className="relative max-w-6xl mx-auto w-full py-20">
            ...
            >
              {beliefCards.map((card) => (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${card.glow} to-transparent blur-2xl rounded-[28px] opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  />
                  <GlassCard className="p-6 sm:p-8 h-full">
                    <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
                      <div
                        className={`w-11 sm:w-12 h-11 sm:h-12 rounded-xl ${card.iconBg} flex items-center justify-center`}
                      >
                        <card.icon
                          className={`w-5 sm:w-6 h-5 sm:h-6 ${card.iconColor}`}
                        />
                      </div>
                      <span
                        className={`text-xs sm:text-sm uppercase tracking-[0.18em] ${card.labelColor} font-semibold`}
                      >
                        {card.label}
                      </span>
                    </div>
