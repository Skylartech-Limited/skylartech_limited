  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#060607] text-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 h-[300px] w-[300px] sm:h-[500px] sm:w-[500px] rounded-full bg-cyan-400/20 blur-3xl" />
        <div className="absolute top-1/2 right-0 h-[250px] w-[250px] sm:h-[450px] sm:w-[450px] rounded-full bg-fuchsia-500/20 blur-3xl" />
        <div className="absolute bottom-0 left-1/2 h-[250px] w-[250px] sm:h-[450px] sm:w-[450px] rounded-full bg-blue-500/20 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-14 xl:px-20 pt-28 sm:pt-32 lg:pt-36 pb-20 sm:pb-24">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* LEFT */}
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-xs sm:text-sm text-cyan-200 backdrop-blur-md">
              <Calendar size={15} />
            ...
            <p className="mt-6 sm:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/70 max-w-2xl">
              The PMI-SP® certification recognizes expertise in project scheduling,
              including the development, maintenance, and control of project timelines
              for successful delivery.
            </p>

            <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {spFocus.map((item, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-4 sm:p-5 hover:border-cyan-400/40 transition-all"
                >
                  <CheckCircle2 className="text-cyan-300 mt-0.5" size={20} />
          ...
          <div>
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-2xl p-5 sm:p-8 shadow-[0_10px_60px_rgba(0,0,0,0.45)]">
              ...
              <div className="flex items-center gap-4 mb-6 sm:mb-8">
                <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 via-fuchsia-500 to-blue-500">
                  <Award size={26} />
                </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    <div className="mt-2 h-2.5 w-2.5 rounded-full bg-cyan-300 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto mt-16 sm:mt-24 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-xl p-5 sm:p-8">
            ...
            <div className="flex items-center gap-4 mb-6 sm:mb-8">
              <div className="flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-cyan-500/10 border border-cyan-500/20">
          ...
          {/* EXAM INFO */}
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-cyan-500/10 via-fuchsia-500/5 to-blue-500/5 backdrop-blur-xl p-5 sm:p-8">
            ...
            {/* FEES */}
            <div className="mt-8 sm:mt-10 rounded-2xl border border-cyan-400/20 bg-cyan-500/5 p-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                  ...
                  <h5 className="text-2xl sm:text-3xl font-black text-cyan-200">
                    US $520
                  </h5>
        ...
        <div className="max-w-5xl mx-auto mt-16 sm:mt-24">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-cyan-400/20 bg-gradient-to-r from-cyan-500/10 via-fuchsia-500/10 to-blue-500/10 p-6 sm:p-10 backdrop-blur-2xl">
            ...
            <div className="relative z-10 text-center">
              ...
              <Link
                to="/book-training"
                className="mt-8 inline-flex w-full sm:w-auto items-center justify-center rounded-2xl bg-gradient-to-r from-cyan-400 via-fuchsia-500 to-blue-500 px-8 py-4 text-sm sm:text-base font-semibold text-black transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(34,211,238,0.35)]"
              >
