...
const PMIACP = () => {
  const agileFocus = [
    "Agile principles, practices, and tools",
    "Scrum, Kanban, Lean, and hybrid approaches",
    "Agile delivery across multiple methodologies",
    "Adaptive project leadership and collaboration",
  ];

  const eligibility = [
    "Minimum 21 contact hours in agile practices",
    "2,000 hours working on project teams within the last five years and 1,500 hours working on agile project teams or agile methodologies within the last three years"
  ];
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#060607] text-white">
      ...
      {/* YELLOW BACKGROUND GLOWS */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 h-[280px] w-[280px] sm:h-[500px] sm:w-[500px] rounded-full bg-yellow-400/10 blur-3xl" />
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-14 xl:px-20 pt-28 sm:pt-32 lg:pt-36 pb-20 sm:pb-24">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* LEFT */}
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400/30 bg-yellow-400/10 px-4 py-2 text-xs sm:text-sm text-yellow-200 backdrop-blur-md">
              <Award size={15} />
            ...
            <p className="mt-6 sm:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/70 max-w-2xl">
              The PMI-ACP® certification recognizes expertise in agile principles,
              practices, and tools across multiple agile methodologies, not limited
              to a single framework.
            </p>

            <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {agileFocus.map((item, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-4 sm:p-5 hover:border-yellow-400/40 transition-all"
                >
                  <CheckCircle2 className="text-yellow-300 mt-0.5" size={20} />
          ...
          <div>
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-2xl p-5 sm:p-8 shadow-[0_10px_60px_rgba(0,0,0,0.45)]">
              ...
              <div className="flex items-center gap-4 mb-6 sm:mb-8">
                <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-yellow-400 to-amber-500">
              ...
              <div className="space-y-4">
                {[
                  "Professionals working on agile project teams",
                  "Scrum Masters, Product Owners, and Agile Coaches",
                  "Team members using Scrum, Kanban, or Lean practices",
                  ...
                  >
                    <div className="mt-2 h-2.5 w-2.5 rounded-full bg-yellow-300 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto mt-16 sm:mt-24 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          {/* EXAM INFO */}
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-yellow-500/10 to-amber-500/5 backdrop-blur-xl p-5 sm:p-8">
            <div className="flex items-center gap-4 mb-6 sm:mb-8">
              <div className="flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-yellow-500/10 border border-yellow-500/20">
        ...
        <div className="max-w-5xl mx-auto mt-16 sm:mt-24">
          <div className="relative overflow-hidden rounded-[2rem] border border-yellow-400/20 bg-gradient-to-r from-yellow-500/10 via-amber-500/10 to-transparent p-6 sm:p-10 backdrop-blur-2xl">
