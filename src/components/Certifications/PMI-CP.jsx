...
const PMICP = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#060607] text-white">
      ...
      {/* NEON GREEN BACKGROUND GLOWS */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 h-[300px] w-[300px] sm:h-[500px] sm:w-[500px] rounded-full bg-green-400/20 blur-3xl" />
        <div className="absolute top-1/2 right-0 h-[250px] w-[250px] sm:h-[450px] sm:w-[450px] rounded-full bg-emerald-500/20 blur-3xl" />
        <div className="absolute bottom-0 left-1/2 h-[250px] w-[250px] sm:h-[450px] sm:w-[450px] rounded-full bg-lime-400/20 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-14 xl:px-20 pt-28 sm:pt-32 lg:pt-36 pb-20 sm:pb-24">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* LEFT */}
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-green-400/30 bg-green-400/10 px-4 py-2 text-xs sm:text-sm text-green-200 backdrop-blur-md">
              <Building2 size={15} />
            ...
            <h1 className="mt-6 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black leading-[1.05]">
              PMI-CP®
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-green-300 via-emerald-300 to-lime-300">
                Certification
              </span>
            </h1>

            <p className="mt-6 sm:mt-8 text-base sm:text-lg leading-7 sm:leading-8 text-white/70 max-w-2xl">
              The PMI-CP™ certification is designed for construction professionals
              who want to master planning, execution, and delivery of complex
              construction and infrastructure projects.
            </p>

            <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {cpFocus.map((item, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-4 sm:p-5 hover:border-green-400/40 transition-all"
                >
                  <CheckCircle2 className="text-green-300 mt-0.5" size={20} />
          ...
          <div>
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-2xl p-5 sm:p-8 shadow-[0_10px_60px_rgba(0,0,0,0.45)]">
              ...
              <div className="flex items-center gap-4 mb-6 sm:mb-8">
                <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-green-400 via-emerald-500 to-lime-400">
                  <Award size={26} />
                </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    <div className="mt-2 h-2.5 w-2.5 rounded-full bg-green-300 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto mt-16 sm:mt-24 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-xl p-5 sm:p-8">
            ...
            <div className="flex items-center gap-4 mb-6 sm:mb-8">
              ...
              <div>
                ...
                <p className="text-white/60 text-xs sm:text-sm mt-1">
                  PMI-CP certification requirements
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {eligibility.map((item, index) => (
                ...
                >
                  <CheckCircle2 className="text-green-300 mt-1" size={20} />
                  <p className="text-sm sm:text-base text-white/75 leading-7">
                    {item}
                  </p>
                </div>
          ...
          {/* EXAM INFO */}
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-green-500/10 via-emerald-500/5 to-lime-500/5 backdrop-blur-xl p-5 sm:p-8">
            ...
            <div className="mt-8 sm:mt-10 rounded-2xl border border-green-400/20 bg-green-500/5 p-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                  ...
                  <h5 className="text-2xl sm:text-3xl font-black text-green-300">
                    $279
                  </h5>
                </div>
        ...
        <div className="max-w-5xl mx-auto mt-16 sm:mt-24">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-green-400/20 bg-gradient-to-r from-green-500/10 via-emerald-500/10 to-lime-500/10 p-6 sm:p-10 backdrop-blur-2xl">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="mt-5 text-sm sm:text-lg text-white/70 max-w-2xl mx-auto leading-7 sm:leading-8">
                Become PMI-CP certified and lead world-class construction and infrastructure delivery.
              </p>
