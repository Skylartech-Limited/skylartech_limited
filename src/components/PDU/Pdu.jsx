        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 mx-auto max-w-3xl text-pretty text-base sm:text-lg text-slate-300 leading-relaxed">
              Our PMI-approved bundles make it simple to earn every PDU you need
              — with expert support and flexible online access at every step.
            </p>
              ...
              <div className="min-w-[900px]">
                ...
                {courses.map((course, i) => (
                  ...
                  >
                    ...
                    <div className="text-slate-300 text-sm">{course.power}</div>
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              ...
              Skylartech to maintain their credentials with confidence and ease.
            </motion.p>
